...
function Weapon:new(world,parent)
	...
	self.load = function()
		...
		self.animation = {
	      ...
	      anim.newAnimation(g('1-4',1),0.05,function() 
	      	self.animc=3 
			self.hitbox:setActive(true)
	      	end),
	      anim.newAnimation(g('5-6',1),0.05, function() self.animc=4 end),
	      anim.newAnimation(g('7-7',1),0.05,function()
